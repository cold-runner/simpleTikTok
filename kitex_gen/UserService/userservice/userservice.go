...
type ChangeUserFollowCountResult struct {
	Success *UserService.BaseResp
}

var ChangeUserFollowCountResult_Success_DEFAULT *UserService.BaseResp

func (p *ChangeUserFollowCountResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(UserService.BaseResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *ChangeUserFollowCountResult) GetSuccess() *UserService.BaseResp {
	if !p.IsSetSuccess() {
...
func (p *ChangeUserFollowCountResult) SetSuccess(x interface{}) {
	p.Success = x.(*UserService.BaseResp)
}
...
func (p *kClient) ChangeUserFollowCount(ctx context.Context, Req *UserService.ChangeUserFollowCountRequest) (r *UserService.BaseResp, err error) {
