...
type Client interface {
	...
	ChangeUserFollowCount(ctx context.Context, Req *UserService.ChangeUserFollowCountRequest, callOptions ...callopt.Option) (r *UserService.BaseResp, err error)
...
func (p *kUserServiceClient) ChangeUserFollowCount(ctx context.Context, Req *UserService.ChangeUserFollowCountRequest, callOptions ...callopt.Option) (r *UserService.BaseResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
