...
var file_idl_UserServer_proto_rawDesc = []byte{
	...
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x32, 0x8e,
	...
	0x2f, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_idl_UserServer_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_idl_UserServer_proto_depIdxs = []int32{
	...
	2, // 2: user.UserService.Register:input_type -> user.UserRegisterRequest
	4, // 3: user.UserService.Login:input_type -> user.UserLoginRequest
	3, // 4: user.UserService.Register:output_type -> user.UserRegisterResponse
	5, // 5: user.UserService.Login:output_type -> user.UserLoginResponse
