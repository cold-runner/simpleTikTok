...
const dsn = "root:my-secret@(localhost:3306)/simple_tiktok?charset=utf8mb4&parseTime=True&loc=Local"
...
func main() {
	...
	g := gen.NewGenerator(gen.Config{
		...
		OutPath:      "./pkg/dao/query", //curd代码的输出路径
		ModelPkgPath: "./pkg/dao/model", //model代码的输出路径
