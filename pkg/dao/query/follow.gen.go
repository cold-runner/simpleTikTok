...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.FollowingUserID = field.NewInt32(tableName, "following_user_id")
	_follow.FollowedUserID = field.NewInt32(tableName, "followed_user_id")
...
type follow struct {
	...
	ALL             field.Asterisk
	ID              field.Int32
	FollowingUserID field.Int32
	FollowedUserID  field.Int32
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.FollowingUserID = field.NewInt32(table, "following_user_id")
	f.FollowedUserID = field.NewInt32(table, "followed_user_id")
