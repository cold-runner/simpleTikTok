...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.FollowingUserID = field.NewInt64(tableName, "following_user_id")
	_follow.FollowedUserID = field.NewInt64(tableName, "followed_user_id")
...
type follow struct {
	...
	ALL             field.Asterisk
	ID              field.Int64
	FollowingUserID field.Int64
	FollowedUserID  field.Int64
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.FollowingUserID = field.NewInt64(table, "following_user_id")
	f.FollowedUserID = field.NewInt64(table, "followed_user_id")
