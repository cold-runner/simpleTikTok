...
type ChatMessage struct {
	...
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty" form:"to_user_id" query:"to_user_id"`           // 消息接收者id
	FromUserId int64  `protobuf:"varint,3,opt,name=from_user_id,json=fromUserId,proto3" json:"from_user_id,omitempty" form:"from_user_id" query:"from_user_id"` // 消息发送者id
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" json:"content,omitempty" form:"content" query:"content"`                                      // 消息内容
	CreateTime int64  `protobuf:"varint,5,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty" form:"create_time" query:"create_time"`     // 消息发送时间
}
...
// Friend list
type DouyinFriendListRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DouyinFriendListRequest) Reset() {
	*x = DouyinFriendListRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DouyinFriendListRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DouyinFriendListRequest) ProtoMessage() {}

func (x *DouyinFriendListRequest) ProtoReflect() protoreflect.Message {
	mi := &file_apiServer_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DouyinFriendListRequest.ProtoReflect.Descriptor instead.
func (*DouyinFriendListRequest) Descriptor() ([]byte, []int) {
	return file_apiServer_proto_rawDescGZIP(), []int{31}
}

func (x *DouyinFriendListRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *DouyinFriendListRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *DouyinFriendListResponse) Reset() {
	*x = DouyinFriendListResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DouyinFriendListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DouyinFriendListResponse) ProtoMessage() {}

func (x *DouyinFriendListResponse) ProtoReflect() protoreflect.Message {
	mi := &file_apiServer_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DouyinFriendListResponse.ProtoReflect.Descriptor instead.
func (*DouyinFriendListResponse) Descriptor() ([]byte, []int) {
	return file_apiServer_proto_rawDescGZIP(), []int{32}
}

func (x *DouyinFriendListResponse) GetBaseResp() *BaseResp {
	if x != nil {
		return x.BaseResp
	}
	return nil
...
func (x *DouyinFriendListResponse) GetUserList() []*User {
	if x != nil {
		return x.UserList
	}
	return nil
...
type DouyinMessageActionRequest struct {
	...
	ToUserId   int64  `protobuf:"varint,1,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty" query:"to_user_id"`     // 用户id
	Token      string `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty" query:"token"`                                   // 用户鉴权token
	ActionType string `protobuf:"bytes,3,opt,name=action_type,json=actionType,proto3" json:"action_type,omitempty" query:"action_type"` // 1-发送消息
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" json:"content,omitempty" query:"content"`                             // 消息内容
}
...
func (x *DouyinMessageActionRequest) GetActionType() string {
	if x != nil {
		return x.ActionType
	}
	return ""
...
type DouyinMessageChatResponse struct {
	...
	BaseResp    *BaseResp      `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty" form:"base_resp" query:"base_resp"`
	ChatMessage []*ChatMessage `protobuf:"bytes,2,rep,name=chat_message,json=chatMessage,proto3" json:"chat_message,omitempty" form:"chat_message" query:"chat_message"` // 聊天记录
}
...
func (x *DouyinMessageChatResponse) GetChatMessage() []*ChatMessage {
	if x != nil {
...
var file_apiServer_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0x98, 0x01, 0x0a, 0x0b, 0x43, 0x68,
	...
	0x54, 0x69, 0x6d, 0x65, 0x22, 0x79, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x12,
	0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12,
	0x23, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04,
	...
	0x4a, 0x0a, 0x08, 0x42, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x1f, 0x0a, 0x0b, 0x73,
	...
	0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x22, 0x74, 0x0a, 0x11, 0x44,
	0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x3e, 0x0a, 0x0b, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x42, 0x1d, 0xb2, 0xbb, 0x18, 0x0b, 0x6c, 0x61, 0x74, 0x65, 0x73,
	0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0xda, 0xbb, 0x18, 0x0a, 0x6c, 0x65, 0x6e, 0x28, 0x24, 0x29,
	0x20, 0x3e, 0x20, 0x30, 0x52, 0x0a, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x54, 0x69, 0x6d, 0x65,
	...
	0x6e, 0x22, 0x94, 0x01, 0x0a, 0x12, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x65, 0x65, 0x64,
	...
	0x52, 0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2f, 0x0a, 0x0a, 0x76, 0x69,
	0x64, 0x65, 0x6f, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10,
	...
	0x65, 0x78, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08,
	0x6e, 0x65, 0x78, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x8f, 0x01, 0x0a, 0x19, 0x44, 0x6f, 0x75,
	...
	0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x1c, 0xb2, 0xbb, 0x18, 0x08, 0x75, 0x73,
	0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0xda, 0xbb, 0x18, 0x0c, 0x6c, 0x65, 0x6e, 0x28, 0x24, 0x29,
	0x20, 0x3c, 0x3d, 0x20, 0x33, 0x32, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65,
	0x12, 0x38, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x1c, 0xb2, 0xbb, 0x18, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64,
	0xda, 0xbb, 0x18, 0x0c, 0x6c, 0x65, 0x6e, 0x28, 0x24, 0x29, 0x20, 0x3c, 0x3d, 0x20, 0x33, 0x32,
	0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x7d, 0x0a, 0x1a, 0x44, 0x6f,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8c, 0x01, 0x0a, 0x16, 0x44, 0x6f,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x1c, 0xb2, 0xbb, 0x18, 0x08, 0x75, 0x73, 0x65, 0x72,
	0x6e, 0x61, 0x6d, 0x65, 0xda, 0xbb, 0x18, 0x0c, 0x6c, 0x65, 0x6e, 0x28, 0x24, 0x29, 0x20, 0x3c,
	0x3d, 0x20, 0x33, 0x32, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x38,
	0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x42, 0x1c, 0xb2, 0xbb, 0x18, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0xda, 0xbb,
	0x18, 0x0c, 0x6c, 0x65, 0x6e, 0x28, 0x24, 0x29, 0x20, 0x3c, 0x3d, 0x20, 0x33, 0x32, 0x52, 0x08,
	0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x7a, 0x0a, 0x17, 0x44, 0x6f, 0x75, 0x79,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x5a, 0x0a, 0x11, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55, 0x73,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x07, 0x75, 0x73, 0x65,
	...
	0x22, 0x6b, 0x0a, 0x12, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	...
	0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x23, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x98, 0x01,
	...
	,
	...
	0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x61, 0x0a, 0x18, 0x44, 0x6f, 0x75,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x7e, 0x0a, 0x19,
	...
	0x70, 0x52, 0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2f, 0x0a, 0x0a, 0x76,
	0x69, 0x64, 0x65, 0x6f, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x10, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x56, 0x69, 0x64, 0x65,
	0x6f, 0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x99, 0x01, 0x0a,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22, 0x50, 0x0a, 0x1c, 0x44, 0x6f, 0x75, 0x79,
	0x69, 0x6e, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x09, 0x62, 0x61, 0x73, 0x65,
	0x5f, 0x72, 0x65, 0x73, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x41, 0x70,
	0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x52, 0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x62, 0x0a, 0x19, 0x44, 0x6f,
	...
	0x18, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x7f,
	...
	,
	...
	0x6f, 0x5f, 0x69, 0x64, 0x52, 0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22, 0x84, 0x01,
	0x0a, 0x19, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c,
	0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x09, 0x62,
	...
	0x65, 0x73, 0x70, 0x52, 0x08, 0x62, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x35, 0x0a,
	0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e,
	0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74,
	0x4c, 0x69, 0x73, 0x74, 0x22, 0xba, 0x01, 0x0a, 0x1b, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x52,
	...
	,
	...
	0x65, 0x73, 0x70, 0x22, 0x68, 0x0a, 0x1f, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x52, 0x65, 0x6c,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x42, 0x0b, 0xb2, 0xbb, 0x18, 0x07, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x05,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xb2, 0xbb, 0x18,
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x82, 0x01,
	...
	0x73, 0x74, 0x22, 0x6a, 0x0a, 0x21, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x52, 0x65, 0x6c, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x42, 0x0b, 0xb2, 0xbb, 0x18, 0x07, 0x75, 0x73,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1f, 0x0a,
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09, 0xb2, 0xbb,
	0x18, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x84,
	...
	0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x60, 0x0a, 0x17, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46,
	...
	,
	...
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x42, 0x0e, 0xb2, 0xbb, 0x18,
	...
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x88, 0x01, 0x0a, 0x19, 0x44, 0x6f, 0x75, 0x79, 0x69,
	...
	,
	...
	0x74, 0x1a, 0x22, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f,
	...
	0x69, 0x6e, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x2f, 0x12, 0x5d,
	...
	0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x41, 0x70,
	...
	0x2f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x12, 0x56, 0x0a,
	0x04, 0x46, 0x65, 0x65, 0x64, 0x12, 0x1c, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x65, 0x65, 0x64, 0x52, 0x65, 0x71, 0x75,
	...
	0x66, 0x65, 0x65, 0x64, 0x2f, 0x12, 0x7b, 0x0a, 0x0d, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x25, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76,
	...
	0x6e, 0x2f, 0x12, 0x73, 0x0a, 0x0b, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x4c, 0x69, 0x73,
	0x74, 0x12, 0x23, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f,
	0x75, 0x79, 0x69, 0x6e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x4c, 0x69, 0x73, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
	...
	0x68, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x12, 0x7f, 0x0a, 0x0e, 0x46, 0x61, 0x76, 0x6f, 0x72,
	0x69, 0x74, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x2e, 0x41, 0x70, 0x69, 0x53,
	...
	0x74, 0x1a, 0x27, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f,
	...
	0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x12, 0x79, 0x0a, 0x0c, 0x46, 0x61, 0x76, 0x6f,
	0x72, 0x69, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x24, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x61, 0x76, 0x6f, 0x72,
	0x69, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27,
	0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69,
	...
	0x73, 0x74, 0x2f, 0x12, 0x7b, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x25, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x41, 0x70,
	0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x43, 0x6f,
	...
	0x23, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79,
	0x69, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x6c, 0x69, 0x73, 0x74, 0x2f, 0x12, 0x7f, 0x0a, 0x0e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72,
	...
	0x27, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x12, 0x90, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x6c, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x2a, 0x2e,
	0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x4c, 0x69,
	0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2b, 0x2e, 0x41, 0x70, 0x69, 0x53,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x21, 0xca, 0xc1, 0x18, 0x1d, 0x2f, 0x64, 0x6f, 0x75,
	0x79, 0x69, 0x6e, 0x2f, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x66, 0x6f, 0x6c,
	0x6c, 0x6f, 0x77, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x12, 0x98, 0x01, 0x0a, 0x14, 0x52, 0x65,
	0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x2c, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44,
	...
	0x1a, 0x2d, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75,
	...
	0x23, 0xca, 0xc1, 0x18, 0x1f, 0x2f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x72, 0x65, 0x6c,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x2f, 0x6c,
	0x69, 0x73, 0x74, 0x2f, 0x12, 0x77, 0x0a, 0x0a, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x22, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44,
	0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x4c,
	...
	0x6e, 0x2f, 0x66, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x7a, 0x0a,
	0x0d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x25,
	0x2e, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69,
	...
	0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x41,
	...
	0x67, 0x65, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x72, 0x0a, 0x0b, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x43, 0x68, 0x61, 0x74, 0x12, 0x23, 0x2e, 0x41, 0x70, 0x69, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x24, 0x2e,
	0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x42, 0x39, 0x5a,
	0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x6c, 0x64,
	0x2d, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2f, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x54, 0x69,
	0x6b, 0x54, 0x6f, 0x6b, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x41,
...
var file_apiServer_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_apiServer_proto_goTypes = []interface{}{
	(*User)(nil),                               // 0: ApiServer.User
	(*Video)(nil),                              // 1: ApiServer.Video
	(*ChatMessage)(nil),                        // 2: ApiServer.ChatMessage
	(*Comment)(nil),                            // 3: ApiServer.Comment
	(*BaseResp)(nil),                           // 4: ApiServer.BaseResp
	(*DouyinFeedRequest)(nil),                  // 5: ApiServer.DouyinFeedRequest
	(*DouyinFeedResponse)(nil),                 // 6: ApiServer.DouyinFeedResponse
	(*DouyinUserRegisterRequest)(nil),          // 7: ApiServer.DouyinUserRegisterRequest
	(*DouyinUserRegisterResponse)(nil),         // 8: ApiServer.DouyinUserRegisterResponse
	(*DouyinUserLoginRequest)(nil),             // 9: ApiServer.DouyinUserLoginRequest
	(*DouyinUserLoginResponse)(nil),            // 10: ApiServer.DouyinUserLoginResponse
	(*DouyinUserRequest)(nil),                  // 11: ApiServer.DouyinUserRequest
	(*DouyinUserResponse)(nil),                 // 12: ApiServer.DouyinUserResponse
	(*DouyinPublishActionRequest)(nil),         // 13: ApiServer.DouyinPublishActionRequest
	(*DouyinPublishActionResponse)(nil),        // 14: ApiServer.DouyinPublishActionResponse
	(*DouyinPublishListRequest)(nil),           // 15: ApiServer.DouyinPublishListRequest
	(*DouyinPublishListResponse)(nil),          // 16: ApiServer.DouyinPublishListResponse
	(*DouyinFavoriteActionRequest)(nil),        // 17: ApiServer.DouyinFavoriteActionRequest
	(*DouyinFavoriteActionResponse)(nil),       // 18: ApiServer.DouyinFavoriteActionResponse
	(*DouyinFavoriteListRequest)(nil),          // 19: ApiServer.DouyinFavoriteListRequest
	(*DouyinFavoriteListResponse)(nil),         // 20: ApiServer.DouyinFavoriteListResponse
	(*DouyinCommentActionRequest)(nil),         // 21: ApiServer.DouyinCommentActionRequest
	(*DouyinCommentActionResponse)(nil),        // 22: ApiServer.DouyinCommentActionResponse
	(*DouyinCommentListRequest)(nil),           // 23: ApiServer.DouyinCommentListRequest
	(*DouyinCommentListResponse)(nil),          // 24: ApiServer.DouyinCommentListResponse
	(*DouyinRelationActionRequest)(nil),        // 25: ApiServer.DouyinRelationActionRequest
	(*DouyinRelationActionResponse)(nil),       // 26: ApiServer.DouyinRelationActionResponse
	(*DouyinRelationFollowListRequest)(nil),    // 27: ApiServer.DouyinRelationFollowListRequest
	(*DouyinRelationFollowListResponse)(nil),   // 28: ApiServer.DouyinRelationFollowListResponse
	(*DouyinRelationFollowerListRequest)(nil),  // 29: ApiServer.DouyinRelationFollowerListRequest
	(*DouyinRelationFollowerListResponse)(nil), // 30: ApiServer.DouyinRelationFollowerListResponse
	(*DouyinFriendListRequest)(nil),            // 31: ApiServer.DouyinFriendListRequest
	(*DouyinFriendListResponse)(nil),           // 32: ApiServer.DouyinFriendListResponse
	(*DouyinMessageActionRequest)(nil),         // 33: ApiServer.DouyinMessageActionRequest
	(*DouyinMessageActionResponse)(nil),        // 34: ApiServer.DouyinMessageActionResponse
	(*DouyinMessageChatRequest)(nil),           // 35: ApiServer.DouyinMessageChatRequest
	(*DouyinMessageChatResponse)(nil),          // 36: ApiServer.DouyinMessageChatResponse
}
var file_apiServer_proto_depIdxs = []int32{
	...
	4,  // 2: ApiServer.DouyinFeedResponse.base_resp:type_name -> ApiServer.BaseResp
	1,  // 3: ApiServer.DouyinFeedResponse.video_list:type_name -> ApiServer.Video
	4,  // 4: ApiServer.DouyinUserRegisterResponse.base_resp:type_name -> ApiServer.BaseResp
	4,  // 5: ApiServer.DouyinUserLoginResponse.base_resp:type_name -> ApiServer.BaseResp
	4,  // 6: ApiServer.DouyinUserResponse.base_resp:type_name -> ApiServer.BaseResp
	0,  // 7: ApiServer.DouyinUserResponse.user:type_name -> ApiServer.User
	4,  // 8: ApiServer.DouyinPublishActionResponse.base_resp:type_name -> ApiServer.BaseResp
	4,  // 9: ApiServer.DouyinPublishListResponse.base_resp:type_name -> ApiServer.BaseResp
	1,  // 10: ApiServer.DouyinPublishListResponse.video_list:type_name -> ApiServer.Video
	4,  // 11: ApiServer.DouyinFavoriteActionResponse.base_resp:type_name -> ApiServer.BaseResp
	...
	4,  // 19: ApiServer.DouyinRelationFollowListResponse.base_resp:type_name -> ApiServer.BaseResp
	0,  // 20: ApiServer.DouyinRelationFollowListResponse.user_list:type_name -> ApiServer.User
	4,  // 21: ApiServer.DouyinRelationFollowerListResponse.base_resp:type_name -> ApiServer.BaseResp
	0,  // 22: ApiServer.DouyinRelationFollowerListResponse.user_list:type_name -> ApiServer.User
	4,  // 23: ApiServer.DouyinFriendListResponse.base_resp:type_name -> ApiServer.BaseResp
	0,  // 24: ApiServer.DouyinFriendListResponse.user_list:type_name -> ApiServer.User
	4,  // 25: ApiServer.DouyinMessageActionResponse.base_resp:type_name -> ApiServer.BaseResp
	4,  // 26: ApiServer.DouyinMessageChatResponse.base_resp:type_name -> ApiServer.BaseResp
	2,  // 27: ApiServer.DouyinMessageChatResponse.chat_message:type_name -> ApiServer.ChatMessage
	7,  // 28: ApiServer.ApiService.Register:input_type -> ApiServer.DouyinUserRegisterRequest
	9,  // 29: ApiServer.ApiService.Login:input_type -> ApiServer.DouyinUserLoginRequest
	11, // 30: ApiServer.ApiService.GetUserInfo:input_type -> ApiServer.DouyinUserRequest
	5,  // 31: ApiServer.ApiService.Feed:input_type -> ApiServer.DouyinFeedRequest
	13, // 32: ApiServer.ApiService.PublishAction:input_type -> ApiServer.DouyinPublishActionRequest
	...
	29, // 40: ApiServer.ApiService.RelationFollowerList:input_type -> ApiServer.DouyinRelationFollowerListRequest
	31, // 41: ApiServer.ApiService.FriendList:input_type -> ApiServer.DouyinFriendListRequest
	33, // 42: ApiServer.ApiService.MessageAction:input_type -> ApiServer.DouyinMessageActionRequest
	35, // 43: ApiServer.ApiService.MessageChat:input_type -> ApiServer.DouyinMessageChatRequest
	8,  // 44: ApiServer.ApiService.Register:output_type -> ApiServer.DouyinUserRegisterResponse
	10, // 45: ApiServer.ApiService.Login:output_type -> ApiServer.DouyinUserLoginResponse
	12, // 46: ApiServer.ApiService.GetUserInfo:output_type -> ApiServer.DouyinUserResponse
	6,  // 47: ApiServer.ApiService.Feed:output_type -> ApiServer.DouyinFeedResponse
	14, // 48: ApiServer.ApiService.PublishAction:output_type -> ApiServer.DouyinPublishActionResponse
	...
	30, // 56: ApiServer.ApiService.RelationFollowerList:output_type -> ApiServer.DouyinRelationFollowerListResponse
	32, // 57: ApiServer.ApiService.FriendList:output_type -> ApiServer.DouyinFriendListResponse
	34, // 58: ApiServer.ApiService.MessageAction:output_type -> ApiServer.DouyinMessageActionResponse
	36, // 59: ApiServer.ApiService.MessageChat:output_type -> ApiServer.DouyinMessageChatResponse
...
func file_apiServer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_apiServer_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DouyinFriendListRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_apiServer_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DouyinFriendListResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
