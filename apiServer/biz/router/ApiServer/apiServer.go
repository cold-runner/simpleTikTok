...
import (
	...
	"github.com/cold-runner/simpleTikTok/apiServer/biz/handler/ApiServer"
)
	...
	root := r.Group("/", rootMw()...)
	{
		_douyin := root.Group("/douyin", _douyinMw()...)
		{
			...
			}
			{
				...
				_list.GET("/", append(_videocommentlistMw(), ApiServer.VideoCommentList)...)
			}
		}
		{
		...
		}
		{
			...
			}
			{
				_follow := _relation.Group("/follow", _followMw()...)
				{
					...
					_list2.GET("/", append(_getfollowlistMw(), ApiServer.GetFollowList)...)
				}
			}
			{
				_follower := _relation.Group("/follower", _followerMw()...)
				{
					...
					_list3.GET("/", append(_getfollowerlistMw(), ApiServer.GetFollowerList)...)
				}
			}
		}
		{
